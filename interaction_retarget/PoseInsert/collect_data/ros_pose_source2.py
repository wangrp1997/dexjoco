...
obj_DIR = 'e'  # 1:mp 2:two_peg 3:e in_2  screw_8 502_in
id_obj = 1
...
class ImageProcessor:
    def __init__(self):
        ...
        self.pub = rospy.Publisher("/source/pose", PoseStamped, queue_size=1000)

        self.pub_bbox = rospy.Publisher("/source/bbox", Float64MultiArray, queue_size=1000)
    ...
    def process_images(self):
        while not rospy.is_shutdown():
            ...
            if self.i == 1:
                ...
                self.pose_last = torch.tensor(np.asarray([[ 0.99769634 , 0.06592193, -0.01601988 , 0.00700436],
                                                [ 0.03459984, -0.2913338  , 0.9559961  , 0.01344006],
                                                [ 0.05835391, -0.9543479 , -0.29294342 , 0.30150002],
