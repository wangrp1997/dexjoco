...
# from policy.diffusion_modules.Vconditional_unet1d import ConditionalUnet1D
...
class DiffusionUNetPolicy(nn.Module):
    def __init__(self,
        ...
        self.model = ConditionalUnet1D(
            ...
            local_cond_dim=None,
            global_cond_dim=global_cond_dim,  ## 64
            diffusion_step_embed_dim=diffusion_step_embed_dim, ## 256
            down_dims=down_dims,  ## (256,512)
        ...
        self.noise_scheduler = DDIMScheduler(
            ...
            prediction_type=prediction # sample epsilon sunhan
        )
