...
- **当前阶段**：`p0_l0_label_derivability_done` → 下一步 Observability label smoke（特权标签）；仍禁采集/训练/真实写盘/重开 C1.1。
- 验收口径：`docs/P0_ACCEPTANCE_CHECKLIST.md`；标签派生：`docs/P0_LABEL_DERIVABILITY_AUDIT.md`。
